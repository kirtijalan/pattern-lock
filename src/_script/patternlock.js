    ...
    var buttonTouchEnd = function(){
        if (isdrawing){
            ...
            if (autoSubmit){
                ...
                if(doSubmit){
                    if(document.forms[0].name==="confirm-code-form"){
                        createCookie("confPwd", document.forms[0].firstChild.firstChild.value, 730);
                    }
                    else{
                        createCookie("pwd", document.forms[0].firstChild.firstChild.value, 730);
